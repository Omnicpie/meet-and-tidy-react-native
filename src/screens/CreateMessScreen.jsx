...
function CreateMessScreen({ navigation, route }) {
  ...
  function currentScreen() {
    switch (screen) {
      case 1:
        return (
          <View>
            <MessLocation location={location} onChangeLocation={onChangeLocation} onNext={onNext} />
          </View>
        );
      case 2:
        return (
          ...
          <View>
            ...
            <View style={Events.buttonContainer}>
              <View style={Events.buttonElement}>
                ...
                <Button onPress={createMessAndProceed} title="Save" />
              </View>
            </View>
          </View>
        );
