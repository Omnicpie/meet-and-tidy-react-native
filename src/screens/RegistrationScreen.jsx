...
export default function RegistrationScreen({ navigation }) {
  ...
  const [createAccount] = useMutation(CREATE_ACCOUNT, responses);
    ...
    <SafeAreaView style={Main.mainContainer}>
      <ScrollView>
        ...
        <Text style={Main.regSubheading}>
          Introduce yourself so the organiser and other attendees can see who is attending. Your
          email address is used to let you know about any changes to this event. We won’t share your
          details or send you any marketing without your permission.
        </Text>
        <View>
        ...
        {mutationFailed && (
          <View>
            <Text style={Main.mutation}>Unable to create account, please try again.</Text>
          </View>
        )}
      </ScrollView>
    </SafeAreaView>
